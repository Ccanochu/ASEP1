...
<head>
    ...
    <title>Centro de Salud Omia</title>
    ...
    <link rel="stylesheet" href="./Vistas/js/prueba.js">
...
<script src="./Vistas/js/doctores.js"></script>
<script src="./Vistas/js/pacientes.js"></script>
<script src="./Vistas/js/secretarias.js"></script>
    ...
    $('#calendar').fullCalendar({
        ...
        events:[
            ...
            foreach($resultado as $key => $value){
                ...
                }else if ($value['id_doctor'] == $iddoctor){
