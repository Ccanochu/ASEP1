...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		$resultado = DoctoresC::DoctorC($columna, $_SESSION["id"]);
				...
				<div class="modal-body">
					...
					<div class="box-body">
						...
						echo '<div class="form-group">
								...
								<input type="text" name="Did" value="'.$resultado["id"].'">
						...
						<div class="form-group">
							...
							echo '<select class="form-control input-lg" name="nombreP">
								...
								foreach ($resultado as $key => $value) {
									...
									echo '<option value="'.$value["nombre"].' '.$value["apellido"].'">'.$value["id"].' '.$value["apellido"].' '.$value["nombre"].'</option>';
						...
						<div class="form-group">
							...
							<input type="text" class="form-control input-lg" name="documentoP" value="" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" autocomplete="off" maxlength="5" >
